# Değerlendirme: 2026-09-20 01:53 — tanim-sorusu
...
> **Uyarı:** İlk token ortalaması 5.28 sn, 3.0 sn sınırının üstünde. Ekran kartı belleği bozuk düzende olabilir (rag_iyilestirme_plani.md Bölüm 2.5); süre ölçütleri geçersiz sayılmalı. Doğruluk ölçütleri bundan etkilenmez. Sunucuyu yeniden başlatıp (foundry server stop) tekrar ölçün.

Puanlanan soru: 51 (36 cevaplanabilir, 15 cevaplanamaz). Senaryoların hazırlık soruları özete katılmaz.

Karşılaştırılan çalışma: `degerlendirmeler/2026-09-19_0335_kontrol2_ilk-olcum.json`

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 76.5% | 82.4% |
| Arama: doğru parça 1. sırada (hit@1) | 72.2% | 77.8% |
| Arama: doğru parça ilk 3'te (hit@3) | 83.3% | 88.9% |
| Arama: MRR (1 = hep 1. sırada) | 0.788 | 0.843 |
| Cevaplanabilir sorularda başarı | 80.6% | 86.1% |
| Yanlış red (cevap belgede varken) | 11.1% | 5.6% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 90.6% | 91.2% |
| Bilinen yanlışı içeren cevap | 0 adet | 0 adet |
| Kaynak satırı var | 100.0% | 100.0% |
| Kaynak doğru belge | 93.8% | 94.1% |
| Cevaplanamaz soruları reddetme | 66.7% | 73.3% |
|   bunun eşikte olanı | 6.7% | 6.7% |
...
| Süre ortalaması | 4.38 sn | 6.52 sn |
| Süre medyanı | 3.77 sn | 6.71 sn |
| En uzun süre | 10.78 sn | 14.96 sn |
| İlk token ortalaması (modele giden sorular) | 3.17 sn | 5.28 sn |
| Arama süresi ortalaması | 0.447 sn | 0.466 sn |
...
| takip | 4 | 2 | 2 | 3 | 1 |
| takip_cevapsiz | 3 | 1 | - | - | - |
| konu_degisimi | 3 | 3 | 3 | 3 | 0 |
| konu_disi_sonra | 2 | 2 | - | - | - |
| hazirlik (puanlanmaz) | 12 | - | - | - | - |

## Önceki çalışmaya göre değişen sorular

Cevap metni değişen soru: 4. Sonucu değişen soru: 3.

- **k2-cevapsiz-pecenek-nufus** HATA → OK: Peçeneklerin nüfusu ne kadardı?
- **k2-degisim-balbal#2** HATA → OK: Balbal nedir?
- **k2-degisim-semeni#2** HATA → OK: Semeni nedir?
...
|---|---|---|---|---|---|---|---|---|---|
| k2-beylik-konum | normal | 1 | 0.805 |  |  | tam | doğru | 4.4 | OK |
| k2-asistan-internet | normal | 1 | 0.64 |  |  | tam | doğru | 2.4 | OK |
| k2-juanjuan | normal | 1 | 0.698 |  |  | tam | doğru | 2.4 | OK |
| k2-kirgizistan | normal | 1 | 0.698 |  |  | tam | doğru | 2.2 | OK |
| k2-kuvayi | normal | 1 | 0.503 |  |  | tam | doğru | 2.4 | OK |
| k2-ilk-anayasa | normal | 1 | 0.654 |  |  | tam | doğru | 2.4 | OK |
| k2-dlt-harita | normal | 1 | 0.731 |  |  | tam | doğru | 2.4 | OK |
| k2-akif-meslek | normal | 1 | 0.817 |  |  | tam | doğru | 1.8 | OK |
| k2-sofya | normal | 2 | 0.652 |  |  | tam | doğru | 2.5 | OK |
...
| k2-mehter-calgi | normal | 1 | 0.646 |  |  | tam | doğru | 2.1 | OK |
| k2-sinan-dogum | normal | 1 | 0.746 |  |  | tam | doğru | 1.9 | OK |
| k2-barbaros-cezayir | normal | 1 | 0.773 |  |  | tam | doğru | 1.8 | OK |
| k2-saka-destan | normal | 1 | 0.714 |  |  | tam | doğru | 2.0 | OK |
| k2-biruni-dil | normal | 1 | 0.677 |  |  | tam | doğru | 1.9 | OK |
| k2-kurt-tug | normal | 1 | 0.731 |  |  | tam | doğru | 2.5 | OK |
| k2-kutsal-sayi | normal | 1 | 0.772 |  |  | tam | doğru | 3.3 | OK |
| k2-karahanli-bolunme | normal | 1 | 0.689 |  |  | tam | doğru | 2.3 | OK |
| k2-uygur-matbaa | normal | 10 | 0.614 |  |  | eksik | yanlış | 6.6 | HATA |
| k2-miryokefalon | normal | 1 | 0.484 |  |  | tam | doğru | 8.7 | OK |
| k2-kut-soy | normal | 2 | 0.545 |  |  | tam | doğru | 7.0 | OK |
| k2-uygur-alfabe | normal | 1 | 0.752 |  |  | tam | doğru | 6.3 | OK |
| k2-fetret | normal | 6 | 0.563 |  |  | eksik | yanlış | 9.9 | HATA |
| k2-ahal-teke | normal | 1 | 0.528 |  |  | tam | doğru | 8.7 | OK |
| k2-turk-yurdu | normal | 1 | 0.74 |  |  | tam | doğru | 8.4 | OK |
| k2-sened | normal | 1 | 0.517 |  |  | tam | doğru | 8.8 | OK |
| k2-cevapsiz-sinan-sayi | yakin |  | 0.716 |  |  |  | var | 9.5 | HATA |
| k2-cevapsiz-barbaros-dogum | yakin |  | 0.794 |  | evet |  |  | 6.2 | OK |
| k2-cevapsiz-akif-mezar | yakin |  | 0.773 |  |  |  | var | 6.5 | HATA |
| k2-cevapsiz-pecenek-nufus | yakin |  | 0.476 |  | evet |  |  | 8.0 | OK |
| k2-cevapsiz-biruni-ogrenci | yakin |  | 0.698 |  | evet |  |  | 6.0 | OK |
| k2-cevapsiz-kadi-maas | yakin |  | 0.578 |  | evet |  |  | 8.2 | OK |
| k2-disi-corba | konu_disi |  | 0.442 |  | evet |  |  | 7.9 | OK |
| k2-disi-dolar | konu_disi |  | 0.393 |  | evet |  |  | 5.1 | OK |
| k2-disi-kod | konu_disi |  | 0.326 | evet | evet |  |  | 0.4 | OK |
| k2-anlamsiz | anlamsiz |  | 0.378 |  | evet |  |  | 7.4 | OK |
| k2-takip-sinan#1 | hazirlik |  | 0.718 |  |  |  | var | 8.9 | - |
| k2-takip-sinan#2 | takip | 2 | 0.705 |  |  | eksik | doğru | 10.4 | HATA |
| k2-takip-preveze#1 | hazirlik |  | 0.8 |  |  |  | var | 6.6 | - |
| k2-takip-preveze#2 | takip | 1 | 0.833 |  |  | tam | doğru | 6.4 | OK |
| k2-takip-akif#1 | hazirlik |  | 0.714 |  |  |  | var | 6.7 | - |
| k2-takip-akif#2 | takip | 31 | 0.72 |  | evet |  |  | 7.0 | HATA |
| k2-takip-karahanli#1 | hazirlik |  | 0.727 |  |  |  | var | 6.4 | - |
| k2-takip-karahanli#2 | takip | 1 | 0.72 |  |  | tam | doğru | 7.4 | OK |
| k2-cevapsiz-takip-sinan#1 | hazirlik |  | 0.742 |  |  |  | var | 7.1 | - |
| k2-cevapsiz-takip-sinan#2 | takip_cevapsiz |  | 0.732 |  |  |  | var | 8.2 | HATA |
| k2-cevapsiz-takip-nevruz#1 | hazirlik |  | 0.762 |  |  |  | var | 9.0 | - |
| k2-cevapsiz-takip-nevruz#2 | takip_cevapsiz |  | 0.747 |  | evet |  |  | 9.9 | OK |
| k2-cevapsiz-takip-kadi#1 | hazirlik |  | 0.565 |  |  |  | var | 14.9 | - |
| k2-cevapsiz-takip-kadi#2 | takip_cevapsiz |  | 0.441 |  |  |  | var | 11.5 | HATA |
| k2-degisim-mehter#1 | hazirlik |  | 0.677 |  |  |  | var | 8.1 | - |
| k2-degisim-mehter#2 | konu_degisimi | 1 | 0.64 |  |  | tam | doğru | 9.9 | OK |
| k2-degisim-balbal#1 | hazirlik |  | 0.782 |  |  |  | var | 7.9 | - |
| k2-degisim-balbal#2 | konu_degisimi | 1 | 0.345 |  |  | tam | doğru | 11.8 | OK |
| k2-degisim-semeni#1 | hazirlik |  | 0.727 |  |  |  | var | 9.9 | - |
| k2-degisim-semeni#2 | konu_degisimi | 1 | 0.4 |  |  | tam | doğru | 12.4 | OK |
| k2-disi-sonra-hava#1 | hazirlik |  | 0.712 |  |  |  | var | 13.2 | - |
| k2-disi-sonra-hava#2 | konu_disi_sonra |  | 0.627 |  | evet |  |  | 11.0 | OK |
| k2-disi-sonra-tarif#1 | hazirlik |  | 0.565 |  |  |  | var | 15.0 | - |
| k2-disi-sonra-tarif#2 | konu_disi_sonra |  | 0.56 |  | evet |  |  | 11.6 | OK |
...
> Balbal, mezarın çevresine dikilen taşların adıdır; bu taşların, ölen kişinin öbür dünyada hizmetinde bulunacağına inanıldığı düşmanları temsil ettiği kabul edilir. (Kaynak: turk-mitolojisi-ve-gok-tanri.md)

Getirilen: `turk-mitolojisi-ve-gok-tanri.md#2 0.278 | nevruz-ve-turk-bayramlari.md#2 0.345 | nevruz-ve-turk-bayramlari.md#0 0.345 | ozan-asik-gelenegi.md#7 0.326 | ozan-asik-gelenegi.md#6 0.324`
...
> Semeni, bugdayın filizlendirilmesiyle hazırlanan tatlıdır. Buğday tanelerinin suda çimlendirilmesiyle başlayarak hazırlık günleri sürer ve filizlenen buğday yeniden dirilişi ve bereketi simgeler. Bu tatlının yapımı, birçok toplulukta kadınların bir araya gelip türkü söylediği bir tören biçimine sahiptir. (Kaynak: nevruz-ve-turk-bayramlari.md)

Getirilen: `nevruz-ve-turk-bayramlari.md#4 0.361 | osmanli-devlet-teskilati.md#4 0.400 | milli-semboller.md#8 0.377 | selcuklu-ve-osmanli-mimarisi.md#5 0.368 | selcuklu-ve-osmanli-mimarisi.md#6 0.349`
