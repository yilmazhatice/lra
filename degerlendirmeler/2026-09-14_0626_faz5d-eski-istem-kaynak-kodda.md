# Değerlendirme: 2026-09-14 06:26 — faz5d-eski-istem-kaynak-kodda
...
Karşılaştırılan çalışma: `degerlendirmeler/2026-09-14_0557_faz5a-kaynak-kodda.json`
...
| Cevaplanabilir sorularda başarı | 91.9% | 94.6% |
| Yanlış red (cevap belgede varken) | 4.1% | 2.7% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 95.8% | 97.2% |
| Bilinen yanlışı içeren cevap | 1 adet | 1 adet |
| Kaynak satırı var | 98.6% | 100.0% |
| Kaynak doğru belge | 97.2% | 98.6% |
| Cevaplanamaz soruları reddetme | 100.0% | 100.0% |
|   bunun eşikte olanı | 12.5% | 12.5% |
| Red cevabına eklenmiş kaynak satırı | 0 adet | 0 adet |
| Süre ortalaması | 1.75 sn | 1.95 sn |
| Süre medyanı | 1.67 sn | 1.92 sn |
| En uzun süre | 3.24 sn | 3.37 sn |
| İlk token ortalaması (modele giden sorular) | 0.78 sn | 0.74 sn |
| Arama süresi ortalaması | 0.426 sn | 0.425 sn |

## Kategorilere göre

| Kategori | Soru | Başarılı | hit@1 | hit@3 | Yanlış red |
|---|---|---|---|---|---|
| normal | 55 | 54 | 49 | 55 | 0 |
| ozel_ad | 10 | 9 | 9 | 9 | 1 |
| yakin | 6 | 6 | - | - | - |
| konu_disi | 3 | 3 | - | - | - |
| anlamsiz | 1 | 1 | - | - | - |
...
Cevap metni değişen soru: 52. Sonucu değişen soru: 4.

- **canakkale-1** HATA → OK: Çanakkale Deniz Zaferi hangi tarihte kazanılmıştır?
...
- **kurt-6** OK → HATA: Ergenekon'dan çıkan topluluğa yolu kim göstermiştir? (eksik: Börteçine)
...
| canakkale-3 | normal | 1 | 0.572 |  |  | tam | doğru | 2.1 | OK |
| canakkale-4 | normal | 1 | 0.474 |  |  | tam | doğru | 1.8 | OK |
| canakkale-5 | normal | 1 | 0.485 |  |  | tam | doğru | 1.8 | OK |
| ilkturk-1 | normal | 3 | 0.714 |  |  | tam | doğru | 2.1 | OK |
| ilkturk-2 | normal | 1 | 0.619 |  |  | tam | doğru | 1.6 | OK |
...
| isimler-2 | ozel_ad | 1 | 0.523 |  |  | tam | doğru | 3.0 | OK |
| isimler-3 | normal | 1 | 0.847 |  |  | tam | doğru | 1.9 | OK |
| isimler-4 | normal | 1 | 0.703 |  |  | tam | doğru | 2.1 | OK |
| isimler-5 | normal | 3 | 0.523 |  |  | tam | doğru | 1.9 | OK |
| isimler-6 | normal | 1 | 0.608 |  |  | tam | doğru | 1.8 | OK |
| ataturk-1 | normal | 1 | 0.673 |  |  | tam | doğru | 1.6 | OK |
| ataturk-2 | normal | 1 | 0.693 |  |  | tam | doğru | 1.9 | OK |
| ataturk-3 | normal | 1 | 0.479 |  |  | tam | doğru | 2.7 | OK |
| ataturk-4 | normal | 3 | 0.421 |  |  | tam | doğru | 2.1 | OK |
...
| at-1 | normal | 1 | 0.656 |  |  | tam | doğru | 2.6 | OK |
| at-2 | ozel_ad | 1 | 0.346 |  |  | tam | doğru | 2.2 | OK |
| at-3 | normal | 1 | 0.74 |  |  | tam | doğru | 2.7 | OK |
...
| disi-1#2 | konu_disi_sonra |  | 0.562 |  | evet |  |  | 1.6 | OK |
...
> Anadolu Selçuklu Devleti'ni Selçuklular kurmuştur. Kuruluşun tam zamanı 1077 yılında Süleyman Şah tarafından İznik merkezli Anadolu Selçuklu Devleti'nin kurulmasıdır. Devlet daha sonra başkentini Konya'ya taşımıştır.  (Kaynak: selcuklular-ve-malazgirt.md)
...
> Manısa Destanı, farklı derlemelerde yarım milyon dizeye yaklaşır.  (Kaynak: turk-destanlari.md)
