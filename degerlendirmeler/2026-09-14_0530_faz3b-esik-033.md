# Değerlendirme: 2026-09-14 05:30 — faz3b-esik-033
...
Karşılaştırılan çalışma: `degerlendirmeler/2026-09-14_0525_faz3a-takip-farki.json`

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 86.7% | 87.8% |
| Arama: doğru parça 1. sırada (hit@1) | 87.8% | 87.8% |
| Arama: doğru parça ilk 3'te (hit@3) | 95.9% | 95.9% |
| Arama: MRR (1 = hep 1. sırada) | 0.919 | 0.919 |
| Cevaplanabilir sorularda başarı | 91.9% | 93.2% |
| Yanlış red (cevap belgede varken) | 4.1% | 2.7% |
|   bunun eşikte olanı | 1.4% | 0.0% |
...
|   bunun eşikte olanı | 25.0% | 12.5% |
| Red cevabına eklenmiş kaynak satırı | 6 adet | 6 adet |
| Süre ortalaması | 1.89 sn | 1.97 sn |
| Süre medyanı | 1.89 sn | 1.94 sn |
| En uzun süre | 3.5 sn | 3.48 sn |
| İlk token ortalaması (modele giden sorular) | 0.68 sn | 0.72 sn |
| Arama süresi ortalaması | 0.432 sn | 0.424 sn |
...
Cevap metni değişen soru: 2. Sonucu değişen soru: 1.
...
| ilkturk-3 | normal | 1 | 0.758 |  |  | tam | doğru | 1.7 | OK |
...
| selcuklu-4 | normal | 1 | 0.779 |  |  | tam | doğru | 2.8 | OK |
...
| at-1 | normal | 1 | 0.656 |  |  | tam | yanlış | 2.7 | HATA |
...
| alfabe-2 | normal | 1 | 0.712 |  |  | tam | doğru | 1.8 | OK |
...
| cevapsiz-2 | yakin |  | 0.691 |  | evet |  | var | 1.8 | HATA |
...
| disi-1#2 | konu_disi_sonra |  | 0.562 |  | evet |  |  | 1.9 | OK |
