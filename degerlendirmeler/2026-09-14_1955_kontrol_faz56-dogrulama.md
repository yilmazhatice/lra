# Değerlendirme: 2026-09-14 19:55 — faz56-dogrulama
...
Karşılaştırılan çalışma: `degerlendirmeler/2026-09-14_0801_kontrol_hibrit-kapali.json`

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 88.4% | 90.7% |
| Arama: doğru parça 1. sırada (hit@1) | 85.2% | 85.2% |
| Arama: doğru parça ilk 3'te (hit@3) | 88.9% | 88.9% |
| Arama: MRR (1 = hep 1. sırada) | 0.894 | 0.894 |
| Cevaplanabilir sorularda başarı | 88.9% | 85.2% |
| Yanlış red (cevap belgede varken) | 7.4% | 14.8% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 96.0% | 100.0% |
| Bilinen yanlışı içeren cevap | 0 adet | 0 adet |
| Kaynak satırı var | 100.0% | 100.0% |
| Kaynak doğru belge | 100.0% | 100.0% |
| Cevaplanamaz soruları reddetme | 87.5% | 100.0% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Red cevabına eklenmiş kaynak satırı | 0 adet | 0 adet |
| Doğrulamada reddedilen cevaplanabilir | - | 2 adet |
| Doğrulamada reddedilen cevaplanamaz | - | 2 adet |
| Türkçe olmayan yazı kalan cevap | - | 0 adet |
| Türkçe olmayan yazı kesilen cevap | - | 1 adet |
| Süre ortalaması | 2.11 sn | 2.76 sn |
| Süre medyanı | 2.05 sn | 2.79 sn |
| En uzun süre | 3.09 sn | 4.03 sn |
| İlk token ortalaması (modele giden sorular) | 0.81 sn | 0.85 sn |
| Arama süresi ortalaması | 0.49 sn | 0.527 sn |

## Kategorilere göre

| Kategori | Soru | Başarılı | hit@1 | hit@3 | Yanlış red |
|---|---|---|---|---|---|
| normal | 15 | 14 | 14 | 15 | 1 |
| ozel_ad | 5 | 4 | 4 | 4 | 1 |
| yakin | 8 | 8 | - | - | - |
| takip | 4 | 4 | 4 | 4 | 0 |
| takip_cevapsiz | 6 | 6 | - | - | - |
...
Cevap metni değişen soru: 7. Sonucu değişen soru: 3.

- **k-dogu-cephesi** HATA → OK: Kurtuluş Savaşı'nda Doğu Cephesi komutanı kimdi?
- **k-cevapsiz-uygur#2** HATA → OK: ne zaman yıkıldı?
- **k-degisim-okculuk#2** OK → HATA: Atlı okçuluk nedir? (yanlış red (doğrulama))
...
- **k-degisim-otag#2** (konu_degisimi) Otağ nedir?
  ...
  - Cevap: Bu bilgi elimdeki dokümanlarda yok.
- **k-degisim-okculuk#2** (konu_degisimi) Atlı okçuluk nedir?
  - Önceki soru: Orhun Yazıtları kimler adına dikilmiştir?
  - Neden: yanlış red (doğrulama)
  - Cevap: Bu bilgi elimdeki dokümanlarda yok.
...
|---|---|---|---|---|---|---|---|---|---|
| k-canakkale | normal | 1 | 0.626 |  |  | tam | doğru | 3.1 | OK |
| k-mete | normal | 1 | 0.578 |  |  | tam | doğru | 2.6 | OK |
| k-kutluk | normal | 1 | 0.677 |  |  | tam | doğru | 2.8 | OK |
| k-baba | normal | 1 | 0.747 |  |  | tam | doğru | 2.9 | OK |
| k-murad | normal | 1 | 0.49 |  |  | tam | doğru | 2.8 | OK |
| k-saltanat | normal | 1 | 0.622 |  |  | tam | doğru | 3.3 | OK |
| k-kinik | normal | 1 | 0.66 |  |  | tam | doğru | 2.7 | OK |
| k-malazgirt-onem | normal | 1 | 0.738 |  |  | tam | doğru | 4.0 | OK |
| k-akcura | normal | 1 | 0.793 |  |  | tam | doğru | 3.0 | OK |
| k-harf-sayisi | normal | 1 | 0.793 |  | evet |  |  | 3.5 | HATA |
| k-millet-mektep | normal | 1 | 0.608 |  |  | tam | doğru | 2.8 | OK |
| k-bildiri | normal | 2 | 0.814 |  |  | tam | doğru | 3.6 | OK |
| k-veteriner | normal | 1 | 0.81 |  |  | tam | doğru | 3.1 | OK |
| k-kurt-neden | normal | 1 | 0.836 |  |  | tam | doğru | 3.8 | OK |
| k-ad-koyma | normal | 1 | 0.773 |  |  | tam | doğru | 3.6 | OK |
| k-ulus | ozel_ad | 4 | 0.469 |  | evet |  |  | 1.4 | HATA |
| k-toy | ozel_ad | 1 | 0.406 |  |  | tam | doğru | 3.3 | OK |
| k-manasci | ozel_ad | 1 | 0.534 |  |  | tam | doğru | 2.6 | OK |
| k-ortmece | ozel_ad | 1 | 0.424 |  |  | tam | doğru | 3.5 | OK |
| k-asena | ozel_ad | 1 | 0.433 |  |  | tam | doğru | 3.0 | OK |
| k-bumin-baba | yakin |  | 0.549 |  | evet |  |  | 1.6 | OK |
| k-edirne | yakin |  | 0.576 |  | evet |  |  | 1.8 | OK |
| k-alparslan-olum | yakin |  | 0.591 |  | evet |  |  | 2.0 | OK |
| k-gokalp-olum | yakin |  | 0.707 |  | evet |  |  | 2.1 | OK |
| k-macar-kral | yakin |  | 0.521 |  | evet |  |  | 1.6 | OK |
| k-thomsen-univ | yakin |  | 0.397 |  | evet |  |  | 2.4 | OK |
| k-korkut-hikaye | yakin |  | 0.728 |  | evet |  |  | 1.6 | OK |
| k-dogu-cephesi | yakin |  | 0.662 |  | evet |  |  | 3.0 | OK |
| k-takip-gokalp#1 | hazirlik |  | 0.77 |  |  |  | var | 2.7 | - |
| k-takip-gokalp#2 | takip | 1 | 0.809 |  |  | tam | doğru | 3.5 | OK |
| k-takip-korkut#1 | hazirlik |  | 0.776 |  |  |  | var | 2.6 | - |
| k-takip-korkut#2 | takip | 1 | 0.79 |  |  | tam | doğru | 3.2 | OK |
| k-takip-sam#1 | hazirlik |  | 0.706 |  |  |  | var | 2.7 | - |
| k-takip-sam#2 | takip | 1 | 0.76 |  |  | tam | doğru | 3.2 | OK |
| k-takip-konya#1 | hazirlik |  | 0.721 |  | evet |  |  | 2.8 | - |
| k-takip-konya#2 | takip | 1 | 0.74 |  |  | tam | doğru | 3.4 | OK |
| k-cevapsiz-malazgirt#1 | hazirlik |  | 0.663 |  |  |  | var | 2.8 | - |
| k-cevapsiz-malazgirt#2 | takip_cevapsiz |  | 0.419 |  | evet |  |  | 2.5 | OK |
| k-cevapsiz-nutuk#1 | hazirlik |  | 0.503 |  |  |  | var | 3.1 | - |
| k-cevapsiz-nutuk#2 | takip_cevapsiz |  | 0.346 |  | evet |  |  | 1.9 | OK |
| k-cevapsiz-tdk#1 | hazirlik |  | 0.76 |  |  |  | var | 3.1 | - |
| k-cevapsiz-tdk#2 | takip_cevapsiz |  | 0.725 |  | evet |  |  | 2.2 | OK |
| k-cevapsiz-mohac#1 | hazirlik |  | 0.488 |  | evet |  |  | 1.7 | - |
| k-cevapsiz-mohac#2 | takip_cevapsiz |  | 0.424 |  | evet |  |  | 2.5 | OK |
| k-cevapsiz-baskent#1 | hazirlik |  | 0.766 |  |  |  | var | 2.6 | - |
| k-cevapsiz-baskent#2 | takip_cevapsiz |  | 0.722 |  | evet |  |  | 2.3 | OK |
| k-cevapsiz-uygur#1 | hazirlik |  | 0.66 |  |  |  | var | 2.6 | - |
| k-cevapsiz-uygur#2 | takip_cevapsiz |  | 0.435 |  | evet |  |  | 3.7 | OK |
| k-degisim-otag#1 | hazirlik |  | 0.485 |  |  |  | var | 2.8 | - |
| k-degisim-otag#2 | konu_degisimi | 5 | 0.45 |  | evet |  |  | 1.8 | HATA |
| k-degisim-okculuk#1 | hazirlik |  | 0.756 |  |  |  | var | 2.7 | - |
| k-degisim-okculuk#2 | konu_degisimi | 1 | 0.607 |  | evet |  |  | 3.8 | HATA |
| k-degisim-tugrul#1 | hazirlik |  | 0.69 |  |  |  | var | 3.1 | - |
| k-degisim-tugrul#2 | konu_degisimi | 5 | 0.496 |  |  | tam | doğru | 3.8 | OK |
| k-disi-telefon#1 | hazirlik |  | 0.631 |  |  |  | var | 3.0 | - |
| k-disi-telefon#2 | konu_disi_sonra |  | 0.572 |  | evet |  |  | 2.1 | OK |
| k-disi-yagmur#1 | hazirlik |  | 0.75 |  |  |  | var | 2.6 | - |
| k-disi-yagmur#2 | konu_disi_sonra |  | 0.666 |  | evet |  |  | 2.0 | OK |
...
**k-toy** — Toy nedir?
> Toy, devletin önemli kararlarının alındığı meclisdir.  (Kaynak: turk-devlet-gelenegi.md)
