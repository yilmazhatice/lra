# Değerlendirme: 2026-09-19 01:38 — asistan-belgesi
...
| git | d06ef41 (kaydedilmemis degisiklik var) |
...
Karşılaştırılan çalışma: `degerlendirmeler/2026-09-19_0049_hibrit-kapi1.json`

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 96.9% | 95.6% |
| Arama: doğru parça 1. sırada (hit@1) | 86.8% | 86.8% |
| Arama: doğru parça ilk 3'te (hit@3) | 97.2% | 97.2% |
| Arama: MRR (1 = hep 1. sırada) | 0.921 | 0.921 |
| Cevaplanabilir sorularda başarı | 99.3% | 97.9% |
| Yanlış red (cevap belgede varken) | 0.0% | 0.0% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 99.3% | 97.9% |
...
| Süre ortalaması | 2.27 sn | 2.3 sn |
| Süre medyanı | 2.15 sn | 2.25 sn |
| En uzun süre | 4.68 sn | 3.96 sn |
| İlk token ortalaması (modele giden sorular) | 0.92 sn | 0.98 sn |
| Arama süresi ortalaması | 0.427 sn | 0.417 sn |
...
| ozel_ad | 29 | 28 | 25 | 29 | 0 |
| yakin | 6 | 5 | - | - | - |
| konu_disi | 3 | 3 | - | - | - |
| anlamsiz | 1 | 1 | - | - | - |
| takip | 5 | 4 | 4 | 4 | 0 |
| takip_cevapsiz | 2 | 0 | - | - | - |
| konu_degisimi | 4 | 3 | 4 | 4 | 0 |
| konu_disi_sonra | 4 | 3 | - | - | - |
...
Cevap metni değişen soru: 10. Sonucu değişen soru: 2.

- **at-2** OK → HATA: Kımız nedir? (eksik: kısrak)
- **degisim-3#2** OK → HATA: Kımız nedir? (eksik: kısrak)

## Başarısız sorular

- **at-2** (ozel_ad) Kımız nedir?
  - Neden: eksik: kısrak
  - Cevap: Kımız, Orta Asya Türk topluluklarında yaygın olarak tüketilen bir içecektir. Kımız, süt deriden yapılmış tulumlara konup düzenli olarak çalkalanarak mayalandırılır ve hafif ekşi tatlı, düşük alkollü bir içecek olarak elde edilir. Kımız, özellikle yaz aylarında hazırlanır ve şölenlerde veya konuk ağırlamada ikram edilir. (Kaynak: turk-kulturunde-at.md)
...
| osmanli-4 | ozel_ad | 1 | 0.574 |  |  | tam | doğru | 2.7 | OK |
...
| destan-2 | normal | 1 | 0.776 |  |  | tam | doğru | 2.1 | OK |
| destan-3 | normal | 1 | 0.838 |  |  | tam | doğru | 2.2 | OK |
| destan-4 | normal | 1 | 0.628 |  |  | tam | doğru | 2.3 | OK |
| destan-5 | normal | 1 | 0.706 |  |  | tam | doğru | 1.9 | OK |
| gelenek-1 | ozel_ad | 1 | 0.559 |  |  | tam | doğru | 2.4 | OK |
| gelenek-2 | ozel_ad | 1 | 0.642 |  |  | tam | doğru | 2.6 | OK |
...
| at-1 | normal | 1 | 0.656 |  |  | tam | doğru | 3.2 | OK |
| at-2 | ozel_ad | 1 | 0.475 |  |  | eksik | doğru | 2.9 | HATA |
...
| alfabe-3 | normal | 2 | 0.76 |  |  | tam | doğru | 2.3 | OK |
...
| eser-5 | normal | 1 | 0.69 |  |  | tam | doğru | 3.0 | OK |
...
| inkilap-5 | normal | 2 | 0.554 |  |  | tam | doğru | 2.3 | OK |
...
| mit-1 | ozel_ad | 1 | 0.702 |  |  | tam | doğru | 2.8 | OK |
...
| boy-5 | ozel_ad | 1 | 0.59 |  |  | tam | doğru | 2.7 | OK |
...
| nevruz-2 | ozel_ad | 1 | 0.657 |  |  | tam | doğru | 2.1 | OK |
| nevruz-3 | ozel_ad | 1 | 0.65 |  |  | tam | doğru | 2.5 | OK |
| nevruz-4 | normal | 1 | 0.637 |  |  | tam | doğru | 1.9 | OK |
| nevruz-5 | normal | 1 | 0.529 |  |  | tam | doğru | 2.7 | OK |
...
| bilim-1 | normal | 1 | 0.574 |  |  | tam | doğru | 2.7 | OK |
...
| dunya-2 | normal | 1 | 0.697 |  |  | tam | doğru | 3.0 | OK |
...
| takip-cevapsiz-1#2 | takip_cevapsiz |  | 0.579 |  |  |  | var | 3.6 | HATA |
| takip-cevapsiz-2#1 | hazirlik |  | 0.75 |  |  |  | var | 2.0 | - |
| takip-cevapsiz-2#2 | takip_cevapsiz |  | 0.511 |  |  |  | var | 2.7 | HATA |
...
| degisim-3#1 | hazirlik |  | 0.656 |  |  |  | var | 3.3 | - |
| degisim-3#2 | konu_degisimi | 1 | 0.475 |  |  | eksik | doğru | 3.3 | HATA |
| degisim-4#1 | hazirlik |  | 0.712 |  |  |  | var | 2.1 | - |
| degisim-4#2 | konu_degisimi | 1 | 0.555 |  |  | tam | doğru | 2.9 | OK |
...
**at-2** — Kımız nedir?
> Kımız, Orta Asya Türk topluluklarında yaygın olarak tüketilen bir içecektir. Kımız, süt deriden yapılmış tulumlara konup düzenli olarak çalkalanarak mayalandırılır ve hafif ekşi tatlı, düşük alkollü bir içecek olarak elde edilir. Kımız, özellikle yaz aylarında hazırlanır ve şölenlerde veya konuk ağırlamada ikram edilir. (Kaynak: turk-kulturunde-at.md)

