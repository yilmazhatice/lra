# Değerlendirme: 2026-09-18 19:41 — terim-paragraflari
...
Karşılaştırılan çalışma: `degerlendirmeler/2026-09-18_0855_kontrol_kontrol-209parca.json`

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 78.0% | 82.9% |
| Arama: doğru parça 1. sırada (hit@1) | 80.0% | 80.0% |
| Arama: doğru parça ilk 3'te (hit@3) | 88.0% | 92.0% |
| Arama: MRR (1 = hep 1. sırada) | 0.844 | 0.854 |
| Cevaplanabilir sorularda başarı | 76.0% | 84.0% |
| Yanlış red (cevap belgede varken) | 4.0% | 4.0% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 91.7% | 95.8% |
| Bilinen yanlışı içeren cevap | 0 adet | 0 adet |
| Kaynak satırı var | 100.0% | 100.0% |
| Kaynak doğru belge | 79.2% | 87.5% |
...
| Süre ortalaması | 2.9 sn | 3.13 sn |
| Süre medyanı | 2.39 sn | 2.39 sn |
| En uzun süre | 7.25 sn | 9.59 sn |
| İlk token ortalaması (modele giden sorular) | 1.51 sn | 1.71 sn |
| Arama süresi ortalaması | 0.479 sn | 0.498 sn |
...
- **k-ad-koyma** HATA → OK: Dede Korkut hikâyelerindeki ad koyma geleneği nasıldır?
- **k-ulus** HATA → OK: Ülüş nedir?
...
- **k-degisim-otag#2** (konu_degisimi) Otağ nedir?
  ...
  - Neden: eksik: sembol; yanlış kaynak: bozkir-gocebe-yasami.md; doğru parça ilk 3'te değil (sıra 8)
...
|---|---|---|---|---|---|---|---|---|---|
| k-canakkale | normal | 1 | 0.626 |  |  | tam | doğru | 2.5 | OK |
| k-mete | normal | 1 | 0.578 |  |  | tam | doğru | 1.5 | OK |
| k-kutluk | normal | 1 | 0.677 |  |  | tam | doğru | 2.1 | OK |
| k-baba | normal | 1 | 0.747 |  |  | tam | doğru | 1.8 | OK |
| k-murad | normal | 1 | 0.49 |  |  | tam | doğru | 2.1 | OK |
| k-saltanat | normal | 3 | 0.649 |  |  | tam | doğru | 3.0 | OK |
| k-kinik | normal | 1 | 0.66 |  |  | tam | doğru | 2.3 | OK |
| k-malazgirt-onem | normal | 1 | 0.738 |  |  | tam | doğru | 3.2 | OK |
...
| k-ulus | ozel_ad | 3 | 0.469 |  |  | tam | doğru | 3.7 | OK |
| k-toy | ozel_ad | 1 | 0.406 |  |  | tam | doğru | 2.7 | OK |
...
| k-thomsen-univ | yakin |  | 0.397 |  | evet |  |  | 1.8 | OK |
...
| k-takip-sam#1 | hazirlik |  | 0.706 |  |  |  | var | 2.0 | - |
| k-takip-sam#2 | takip | 1 | 0.76 |  |  | tam | doğru | 2.1 | OK |
...
| k-cevapsiz-nutuk#2 | takip_cevapsiz |  | 0.384 |  | evet |  |  | 1.9 | OK |
| k-cevapsiz-tdk#1 | hazirlik |  | 0.76 |  |  |  | var | 4.2 | - |
| k-cevapsiz-tdk#2 | takip_cevapsiz |  | 0.725 |  | evet |  |  | 3.8 | OK |
| k-cevapsiz-mohac#1 | hazirlik |  | 0.488 |  |  |  | var | 3.6 | - |
| k-cevapsiz-mohac#2 | takip_cevapsiz |  | 0.426 |  | evet |  |  | 7.4 | OK |
| k-cevapsiz-baskent#1 | hazirlik |  | 0.766 |  |  |  | var | 3.8 | - |
| k-cevapsiz-baskent#2 | takip_cevapsiz |  | 0.567 |  | evet |  |  | 9.6 | OK |
| k-cevapsiz-uygur#1 | hazirlik |  | 0.66 |  |  |  | var | 3.1 | - |
| k-cevapsiz-uygur#2 | takip_cevapsiz |  | 0.45 |  |  |  | var | 6.6 | HATA |
| k-degisim-otag#1 | hazirlik |  | 0.492 |  |  |  | var | 7.2 | - |
| k-degisim-otag#2 | konu_degisimi | 8 | 0.461 |  |  | eksik | yanlış | 8.8 | HATA |
| k-degisim-okculuk#1 | hazirlik |  | 0.756 |  |  |  | var | 2.0 | - |
| k-degisim-okculuk#2 | konu_degisimi | 1 | 0.607 |  |  | tam | doğru | 4.4 | OK |
| k-degisim-tugrul#1 | hazirlik |  | 0.69 |  |  |  | var | 2.1 | - |
| k-degisim-tugrul#2 | konu_degisimi | 19 | 0.63 |  | evet |  |  | 7.4 | HATA |
| k-disi-telefon#1 | hazirlik |  | 0.631 |  |  |  | var | 3.0 | - |
| k-disi-telefon#2 | konu_disi_sonra |  | 0.572 |  | evet |  |  | 2.0 | OK |
| k-disi-yagmur#1 | hazirlik |  | 0.75 |  |  |  | var | 3.6 | - |
| k-disi-yagmur#2 | konu_disi_sonra |  | 0.666 |  | evet |  |  | 3.8 | OK |
...
**k-ulus** — Ülüş nedir?
> Ülüş, ganimetin ve gelirin boylar arasında paylaştırılması geleneğidir. Savaştan veya vergiden elde edilen malların boylar arasında töreye uygun biçimde bölüştürülmesi beklenir ve bu pay dağıtımındaki sıranın, boyların devlet içindeki yerini de gösterdiği kabul edilir. Hükümdarın cömertliği yöneticilik erdemlerinden biri olarak görülür ve paylaşımda haksızlık yapmanın sonuçlarını zedeleyeceğine inanılır. (Kaynak: turk-devlet-gelenegi.md)

Getirilen: `turk-kulturunde-at.md#2 0.469 | oguz-boylari-ve-turk-boy-yapisi.md#0 0.462 | turk-devlet-gelenegi.md#5 0.459 | turk-mitolojisi-ve-gok-tanri.md#7 0.433 | ozan-asik-gelenegi.md#3 0.416`
...
> Örtmece, korkulan ya da saygı duyulan bir varlığın gerçek adını söylemekten kaçınılıp, daha aptallık veya zayıflığa atıfta bulunan başka bir sözcük kullanma alışkanlığını ifade eder. Bu yöntem, kurt gibi korkunç görünen hayvanların gerçek ismini kullanmaktan kaçınarak, onların zayıf ve aptallık sembolü olarak algılandığı bir sözcük kullanmaya devam etmektedir. (Kaynak: turk-kulturunde-kurt.md)
