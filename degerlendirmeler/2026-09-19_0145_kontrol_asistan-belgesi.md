# Değerlendirme: 2026-09-19 01:45 — asistan-belgesi
...
| Süre ortalaması | 2.36 sn | 2.4 sn |
| Süre medyanı | 2.16 sn | 2.22 sn |
| En uzun süre | 5.2 sn | 5.23 sn |
| İlk token ortalaması (modele giden sorular) | 0.94 sn | 1.01 sn |
...
Cevap metni değişen soru: 5. Sonucu değişen soru: 0.
...
- **k-manasci** (ozel_ad) Manasçı kimdir?
  ...
  - Cevap: Manasçı, Kırgızlarda destan anlatıcısılardır ve Manas Destanı'nını ezberden ve doğaçlama eklemelerle anlatirlar. Manasçılar, yarım milyon dizeye yaklaşan Manas Destanı'nını yazıya bakmadan anlatirlar ve bu anlatım sırasında sesin ve bedenin kullanıldığı özel bir biçim gelişmiştir. Bu gelenek, usta-çırak ilişkisiyle aktarılmış ve 2013'te UNESCO listesine alınmıştır. (Kaynak: ozan-asik-gelenegi.md)
...
|---|---|---|---|---|---|---|---|---|---|
| k-canakkale | normal | 1 | 0.626 |  |  | tam | doğru | 2.7 | OK |
...
| k-malazgirt-onem | normal | 1 | 0.738 |  |  | tam | doğru | 3.6 | OK |
...
| k-ad-koyma | normal | 1 | 0.773 |  |  | tam | doğru | 2.9 | OK |
| k-ulus | ozel_ad | 1 | 0.469 |  |  | tam | doğru | 3.5 | OK |
...
| k-dogu-cephesi | yakin |  | 0.662 |  |  |  | var | 2.7 | HATA |
...
| k-takip-konya#1 | hazirlik |  | 0.721 |  |  |  | var | 2.2 | - |
| k-takip-konya#2 | takip | 2 | 0.55 |  |  | tam | yanlış | 2.8 | HATA |
| k-cevapsiz-malazgirt#1 | hazirlik |  | 0.663 |  |  |  | var | 2.0 | - |
| k-cevapsiz-malazgirt#2 | takip_cevapsiz |  | 0.44 |  | evet |  |  | 2.4 | OK |
| k-cevapsiz-nutuk#1 | hazirlik |  | 0.503 |  |  |  | var | 2.5 | - |
| k-cevapsiz-nutuk#2 | takip_cevapsiz |  | 0.424 |  | evet |  |  | 1.9 | OK |
...
| k-cevapsiz-baskent#1 | hazirlik |  | 0.766 |  |  |  | var | 1.9 | - |
| k-cevapsiz-baskent#2 | takip_cevapsiz |  | 0.567 |  | evet |  |  | 5.2 | OK |
| k-cevapsiz-uygur#1 | hazirlik |  | 0.66 |  |  |  | var | 1.9 | - |
| k-cevapsiz-uygur#2 | takip_cevapsiz |  | 0.45 |  |  |  | var | 3.1 | HATA |
| k-degisim-otag#1 | hazirlik |  | 0.492 |  |  |  | var | 2.2 | - |
| k-degisim-otag#2 | konu_degisimi | 2 | 0.461 |  |  | eksik | yanlış | 3.6 | HATA |
| k-degisim-okculuk#1 | hazirlik |  | 0.756 |  |  |  | var | 1.7 | - |
| k-degisim-okculuk#2 | konu_degisimi | 1 | 0.607 |  |  | tam | doğru | 2.9 | OK |
| k-degisim-tugrul#1 | hazirlik |  | 0.69 |  |  |  | var | 1.8 | - |
| k-degisim-tugrul#2 | konu_degisimi | 19 | 0.63 |  | evet |  |  | 3.1 | HATA |
| k-disi-telefon#1 | hazirlik |  | 0.631 |  |  |  | var | 2.1 | - |
| k-disi-telefon#2 | konu_disi_sonra |  | 0.572 |  | evet |  |  | 1.9 | OK |
| k-disi-yagmur#1 | hazirlik |  | 0.75 |  |  |  | var | 2.1 | - |
| k-disi-yagmur#2 | konu_disi_sonra |  | 0.666 |  | evet |  |  | 2.2 | OK |
...
> Manasçı, Kırgızlarda destan anlatıcısılardır ve Manas Destanı'nını ezberden ve doğaçlama eklemelerle anlatirlar. Manasçılar, yarım milyon dizeye yaklaşan Manas Destanı'nını yazıya bakmadan anlatirlar ve bu anlatım sırasında sesin ve bedenin kullanıldığı özel bir biçim gelişmiştir. Bu gelenek, usta-çırak ilişkisiyle aktarılmış ve 2013'te UNESCO listesine alınmıştır. (Kaynak: ozan-asik-gelenegi.md)
