# Değerlendirme: 2026-09-14 07:09 — faz4-hibrit-kapali
...
| Cevaplanabilir sorularda başarı | 94.6% | 94.6% |
| Yanlış red (cevap belgede varken) | 2.7% | 2.7% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 97.2% | 97.2% |
...
| Süre ortalaması | 1.95 sn | 2.0 sn |
| Süre medyanı | 1.92 sn | 1.96 sn |
| En uzun süre | 3.37 sn | 3.39 sn |
| İlk token ortalaması (modele giden sorular) | 0.74 sn | 0.78 sn |
| Arama süresi ortalaması | 0.425 sn | 0.43 sn |
...
Cevap metni değişen soru: 3. Sonucu değişen soru: 0.
...
|---|---|---|---|---|---|---|---|---|---|
| canakkale-1 | normal | 1 | 0.707 |  |  | tam | doğru | 2.0 | OK |
...
| isimler-3 | normal | 1 | 0.847 |  |  | tam | doğru | 2.0 | OK |
...
| ulku-4 | normal | 1 | 0.787 |  |  | tam | doğru | 2.0 | OK |
...
| cevapsiz-5 | yakin |  | 0.659 |  | evet |  |  | 2.0 | OK |
...
| degisim-4#1 | hazirlik |  | 0.712 |  |  |  | var | 1.9 | - |
| degisim-4#2 | konu_degisimi | 1 | 0.552 |  |  | tam | doğru | 2.5 | OK |
...
> Aşina hanedanının soyu bir dişi kurttan gelir. Göktürklerin türeyişiş anlatısına göre, soyun bir dişi kurttan çıktığı aktarılır.  (Kaynak: turk-kulturunde-kurt.md)
...
> Ülkü Ocakları Derneği adını  1978 Aralık ayında Ülkücü Gençlik Derneği adını almıştır.  (Kaynak: ulku-ocaklari.md)
