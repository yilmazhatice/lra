# Değerlendirme: 2026-09-19 00:57 — hibrit-kapi1
...
| Arama: doğru parça 1. sırada (hit@1) | 80.0% | 84.0% |
| Arama: doğru parça ilk 3'te (hit@3) | 92.0% | 96.0% |
| Arama: MRR (1 = hep 1. sırada) | 0.852 | 0.895 |
...
| Süre ortalaması | 4.38 sn | 2.36 sn |
| Süre medyanı | 4.57 sn | 2.16 sn |
| En uzun süre | 7.67 sn | 5.2 sn |
| İlk token ortalaması (modele giden sorular) | 3.0 sn | 0.94 sn |
| Arama süresi ortalaması | 0.495 sn | 0.496 sn |
...
| k-asena | ozel_ad | 1 | 0.433 |  |  | tam | doğru | 3.1 | OK |
...
| k-macar-kral | yakin |  | 0.521 |  | evet |  |  | 2.2 | OK |
...
| k-cevapsiz-malazgirt#2 | takip_cevapsiz |  | 0.44 |  | evet |  |  | 2.2 | OK |
...
| k-cevapsiz-mohac#2 | takip_cevapsiz |  | 0.426 |  | evet |  |  | 2.3 | OK |
...
> Dede Korkut hikâyelerinde bir gencin ad alabilmesi için önce bir yiğitlik göstermesi gerekmektedir. Bu geleneğin en bilinen örneğidir ve kahramanlık, aile bağları gibi ve ad koyma geleneği ön plana çıkarır. (Kaynak: turk-destanlari.md)
