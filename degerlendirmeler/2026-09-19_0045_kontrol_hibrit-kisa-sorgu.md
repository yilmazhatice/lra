# Değerlendirme: 2026-09-19 00:45 — hibrit-kisa-sorgu
...
| Arama: MRR (1 = hep 1. sırada) | 0.852 | 0.9 |
...
| Süre ortalaması | 4.38 sn | 2.45 sn |
| Süre medyanı | 4.57 sn | 2.17 sn |
| En uzun süre | 7.67 sn | 7.17 sn |
| İlk token ortalaması (modele giden sorular) | 3.0 sn | 0.98 sn |
| Arama süresi ortalaması | 0.495 sn | 0.493 sn |
...
| k-malazgirt-onem | normal | 1 | 0.738 |  |  | tam | doğru | 3.7 | OK |
...
| k-takip-gokalp#2 | takip | 1 | 0.809 |  |  | tam | doğru | 2.1 | OK |
...
| k-cevapsiz-baskent#2 | takip_cevapsiz |  | 0.567 |  |  |  | var | 7.2 | HATA |
...
| k-degisim-okculuk#2 | konu_degisimi | 1 | 0.607 |  |  | tam | doğru | 3.4 | OK |
| k-degisim-tugrul#1 | hazirlik |  | 0.69 |  |  |  | var | 2.0 | - |
| k-degisim-tugrul#2 | konu_degisimi | 6 | 0.63 |  |  | tam | doğru | 4.2 | OK |
| k-disi-telefon#1 | hazirlik |  | 0.631 |  |  |  | var | 2.2 | - |
