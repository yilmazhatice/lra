# Değerlendirme: 2026-09-18 21:13 — red-istemi
...
| git | c00e8b4 (kaydedilmemis degisiklik var) |
| set_parmak_izi | 48c99f2867 |

## Özet

> **Uyarı:** İlk token ortalaması 10.38 sn, 3.0 sn sınırının üstünde. Ekran kartı belleği bozuk düzende olabilir (rag_iyilestirme_plani.md Bölüm 2.5); süre ölçütleri geçersiz sayılmalı. Doğruluk ölçütleri bundan etkilenmez. Sunucuyu yeniden başlatıp (foundry server stop) tekrar ölçün.

Puanlanan soru: 41 (25 cevaplanabilir, 16 cevaplanamaz). Senaryoların hazırlık soruları özete katılmaz.

Karşılaştırılan çalışma: `degerlendirmeler/2026-09-18_1958_kontrol_terim-paragraflari-son.json`

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 82.9% | 85.4% |
| Arama: doğru parça 1. sırada (hit@1) | 80.0% | 80.0% |
| Arama: doğru parça ilk 3'te (hit@3) | 92.0% | 92.0% |
| Arama: MRR (1 = hep 1. sırada) | 0.852 | 0.852 |
| Cevaplanabilir sorularda başarı | 84.0% | 84.0% |
| Yanlış red (cevap belgede varken) | 4.0% | 0.0% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 95.8% | 92.0% |
| Bilinen yanlışı içeren cevap | 0 adet | 0 adet |
| Kaynak satırı var | 100.0% | 100.0% |
| Kaynak doğru belge | 87.5% | 88.0% |
| Cevaplanamaz soruları reddetme | 81.2% | 87.5% |
|   bunun eşikte olanı | 0.0% | 0.0% |
...
| Türkçe olmayan yazı kesilen cevap | 1 adet | 0 adet |
| Süre ortalaması | 2.58 sn | 11.68 sn |
| Süre medyanı | 2.4 sn | 11.57 sn |
| En uzun süre | 5.43 sn | 17.66 sn |
| İlk token ortalaması (modele giden sorular) | 1.17 sn | 10.38 sn |
| Arama süresi ortalaması | 0.498 sn | 0.499 sn |
...
| takip | 4 | 3 | 3 | 4 | 0 |
| takip_cevapsiz | 6 | 5 | - | - | - |
| konu_degisimi | 3 | 2 | 1 | 1 | 0 |
| konu_disi_sonra | 2 | 2 | - | - | - |
| hazirlik (puanlanmaz) | 15 | - | - | - | - |

## Önceki çalışmaya göre değişen sorular

Cevap metni değişen soru: 27. Sonucu değişen soru: 5.

- **k-kurt-neden** OK → HATA: Türk kültüründe sembol olarak neden kurt seçilmiştir? (eksik: evcil)
- **k-dogu-cephesi** HATA → OK: Kurtuluş Savaşı'nda Doğu Cephesi komutanı kimdi?
- **k-cevapsiz-baskent#2** OK → HATA: başkenti neresiydi? (cevaplanamaz soruya cevap verdi)
- **k-cevapsiz-uygur#2** HATA → OK: ne zaman yıkıldı?
- **k-degisim-tugrul#2** HATA → OK: Tuğrul Bey kimdir? (doğru parça ilk 3'te değil (sıra 19))

## Başarısız sorular

- **k-kurt-neden** (normal) Türk kültüründe sembol olarak neden kurt seçilmiştir?
  - Neden: eksik: evcil
  - Cevap: Türk kültüründe kurt sembol olarak seçilmesinin nedeni, kurtun bozkır topluluklarının dayanıklılığı ve sürürümlük niteliklerini yansıttığına ve bu özelliklerin topluluğun kimliğini temsil ettiğine dayanabilir. Ayrıca, kurt figürü siyasi sembolizme de katkıda bulunmuş ve modern dönemde Türk milliyetçilikte önemli bir görsel işaret haline gelmiştir. (Kaynak: turk-kulturunde-kurt.md)
- **k-manasci** (ozel_ad) Manasçı kimdir?
  - Neden: yanlış kaynak: ozan-asik-gelenegi.md
  - Cevap: Manasçı, Kırgızlarda destan anlatıcısını ifade eder ve Manas Destanı'nı ezberden ve doğaçlama eklemelerle anlatır. Manasçılar, yarım milyon dizeye yaklaşan Manas Destanı'nı yazıya bakmadan anlatırlar. Bu anlatım sırasında sesin ve bedenin kullanıldığı özel bir biçim gelişmiştir ve 2013'te UNESCO listesine alınmıştır. (Kaynak: ozan-asik-gelenegi.md)
- **k-edirne** (yakin) Osmanlı başkenti Edirne'ye ne zaman taşınmıştır?
  - Neden: cevaplanamaz soruya cevap verdi
  - Cevap: Osmanlı başkenti Edirne'ye taşınmasının tam tarihi belirsiz olarak verilmemiştir. Ancak, Bursa'nın 1326 yılında alınması ve Edirne'nin 1362 yılında Osmanlı topraklarına girilmesi arasında bir süre olduğu bilinmektedir. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md)
- **k-takip-konya#2** (takip) başkenti daha sonra nereye taşındı?
  ...
  - Cevap: Beyliklerin başkenti Bursa'ya taşındıktan sonra Konya'ya taşındı. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md)
- **k-cevapsiz-baskent#2** (takip_cevapsiz) başkenti neresiydi?
  - Önceki soru: Göktürk Devleti ne zaman kurulmuştur?
  - Neden: cevaplanamaz soruya cevap verdi
  - Cevap: Bursa'nın başkenti 1326 yılında Orhan Gazi döneminde yapılmıştır. Selçukluların başkenti daha sonra Konya'ya taşınmıştır. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md, selcuklular-ve-malazgirt.md)
- **k-degisim-otag#2** (konu_degisimi) Otağ nedir?
  - Önceki soru: Lozan Antlaşması ne zaman imzalanmıştır?
  - Neden: eksik: sembol; yanlış kaynak: bozkir-gocebe-yasami.md; doğru parça ilk 3'te değil (sıra 13)
  - Cevap: Otağ, Türk topluluklarında yurt veya kerege adıyla anılan sökülüp taşınabilen keçe çadırın ismi olan bir yapıdır. Bu yapının tepedeki çemberi hem baca hem pencere görevi görür ve dumanı dışarı verir. Üzeri keçeyle kaplanarak kışın soğuğu geçirmez, sadece sıcağı geçirebilen keçe ile örtülür. (Kaynak: bozkir-gocebe-yasami.md)
...
| k-mete | normal | 1 | 0.578 |  |  | tam | doğru | 9.5 | OK |
| k-kutluk | normal | 1 | 0.677 |  |  | tam | doğru | 12.1 | OK |
| k-baba | normal | 1 | 0.747 |  |  | tam | doğru | 8.2 | OK |
| k-murad | normal | 1 | 0.49 |  |  | tam | doğru | 12.2 | OK |
| k-saltanat | normal | 3 | 0.649 |  |  | tam | doğru | 12.3 | OK |
| k-kinik | normal | 1 | 0.66 |  |  | tam | doğru | 11.8 | OK |
| k-malazgirt-onem | normal | 1 | 0.738 |  |  | tam | doğru | 9.7 | OK |
| k-akcura | normal | 1 | 0.793 |  |  | tam | doğru | 8.6 | OK |
| k-harf-sayisi | normal | 1 | 0.793 |  |  | tam | doğru | 9.2 | OK |
| k-millet-mektep | normal | 1 | 0.608 |  |  | tam | doğru | 11.5 | OK |
| k-kurt-neden | normal | 1 | 0.836 |  |  | eksik | doğru | 11.5 | HATA |
| k-ad-koyma | normal | 1 | 0.773 |  |  | tam | doğru | 12.5 | OK |
| k-ulus | ozel_ad | 3 | 0.469 |  |  | tam | doğru | 11.8 | OK |
| k-toy | ozel_ad | 1 | 0.406 |  |  | tam | doğru | 12.2 | OK |
| k-manasci | ozel_ad | 1 | 0.534 |  |  | tam | yanlış | 11.5 | HATA |
| k-ortmece | ozel_ad | 1 | 0.424 |  |  | tam | doğru | 17.7 | OK |
| k-asena | ozel_ad | 1 | 0.433 |  |  | tam | doğru | 11.6 | OK |
| k-bumin-baba | yakin |  | 0.549 |  | evet |  |  | 10.9 | OK |
| k-edirne | yakin |  | 0.594 |  |  |  | var | 17.2 | HATA |
| k-alparslan-olum | yakin |  | 0.558 |  | evet |  |  | 15.8 | OK |
| k-gokalp-olum | yakin |  | 0.707 |  | evet |  |  | 8.5 | OK |
| k-macar-kral | yakin |  | 0.521 |  | evet |  |  | 15.8 | OK |
| k-thomsen-univ | yakin |  | 0.397 |  | evet |  |  | 11.4 | OK |
| k-korkut-hikaye | yakin |  | 0.728 |  | evet |  |  | 9.0 | OK |
| k-dogu-cephesi | yakin |  | 0.662 |  | evet |  |  | 13.5 | OK |
| k-takip-gokalp#1 | hazirlik |  | 0.77 |  |  |  | var | 8.1 | - |
| k-takip-gokalp#2 | takip | 1 | 0.809 |  |  | tam | doğru | 8.7 | OK |
| k-takip-korkut#1 | hazirlik |  | 0.776 |  |  |  | var | 8.0 | - |
| k-takip-korkut#2 | takip | 1 | 0.79 |  |  | tam | doğru | 8.3 | OK |
| k-takip-sam#1 | hazirlik |  | 0.706 |  |  |  | var | 9.3 | - |
| k-takip-sam#2 | takip | 1 | 0.76 |  |  | tam | doğru | 8.8 | OK |
| k-takip-konya#1 | hazirlik |  | 0.721 |  |  |  | var | 12.0 | - |
| k-takip-konya#2 | takip | 2 | 0.55 |  |  | tam | yanlış | 12.6 | HATA |
| k-cevapsiz-malazgirt#1 | hazirlik |  | 0.663 |  |  |  | var | 9.2 | - |
| k-cevapsiz-malazgirt#2 | takip_cevapsiz |  | 0.44 |  | evet |  |  | 16.3 | OK |
| k-cevapsiz-nutuk#1 | hazirlik |  | 0.503 |  |  |  | var | 16.6 | - |
| k-cevapsiz-nutuk#2 | takip_cevapsiz |  | 0.384 |  | evet |  |  | 10.8 | OK |
| k-cevapsiz-tdk#1 | hazirlik |  | 0.76 |  |  |  | var | 14.8 | - |
| k-cevapsiz-tdk#2 | takip_cevapsiz |  | 0.725 |  | evet |  |  | 11.7 | OK |
| k-cevapsiz-mohac#1 | hazirlik |  | 0.488 |  |  |  | var | 11.1 | - |
| k-cevapsiz-mohac#2 | takip_cevapsiz |  | 0.426 |  | evet |  |  | 17.0 | OK |
| k-cevapsiz-baskent#1 | hazirlik |  | 0.766 |  |  |  | var | 12.3 | - |
| k-cevapsiz-baskent#2 | takip_cevapsiz |  | 0.567 |  |  |  | var | 13.5 | HATA |
| k-cevapsiz-uygur#1 | hazirlik |  | 0.66 |  |  |  | var | 11.3 | - |
| k-cevapsiz-uygur#2 | takip_cevapsiz |  | 0.45 |  | evet |  |  | 12.4 | OK |
| k-degisim-otag#1 | hazirlik |  | 0.492 |  |  |  | var | 16.5 | - |
| k-degisim-otag#2 | konu_degisimi | 13 | 0.461 |  |  | eksik | yanlış | 13.7 | HATA |
| k-degisim-okculuk#1 | hazirlik |  | 0.756 |  |  |  | var | 8.4 | - |
| k-degisim-okculuk#2 | konu_degisimi | 1 | 0.607 |  |  | tam | doğru | 12.0 | OK |
| k-degisim-tugrul#1 | hazirlik |  | 0.69 |  |  |  | var | 8.4 | - |
| k-degisim-tugrul#2 | konu_degisimi | 19 | 0.63 |  |  | tam | doğru | 13.1 | OK |
| k-disi-telefon#1 | hazirlik |  | 0.631 |  |  |  | var | 10.5 | - |
| k-disi-telefon#2 | konu_disi_sonra |  | 0.572 |  | evet |  |  | 8.9 | OK |
| k-disi-yagmur#1 | hazirlik |  | 0.75 |  |  |  | var | 11.2 | - |
| k-disi-yagmur#2 | konu_disi_sonra |  | 0.666 |  | evet |  |  | 11.7 | OK |
...
> İkinci Göktürk Devleti veya Kutluk Devleti, 682'de İlteriş Kutluk Kağan tarafından bağımsızlığı yeniden kazanılarak kurulmuştur. (Kaynak: ilk-turk-devletleri.md)
...
> Osmanlı saltanatı 1 Kasım 1922'de kaldırılmıştır. Bu tarih, Türkiye Büyük Millet Meclisi tarafından belirlenmiştir ve VI. Mehmed Vahdettin padişahının saltanatının sona erdiği zamandır. (Kaynak: osmanli-padisahlari.md)
...
> Yirmi dokuz harf vardır. (Kaynak: turkcenin-tarihi-ve-alfabeleri.md)
...
> Dede Korkut hikâyelerinde bir gencin ancak bir yiğitlik gösterdikten sonra ad alması ad koyma geleneğinin en bilinen örneğidir. Bu geleneğ, kahramanlık ve yiğitlik gösterimi ile adlandırılmanın bir bağlantısıdır. (Kaynak: turk-destanlari.md)
...
**k-ulus** — Ülüş nedir?
> Ülüş, Türk devlet geleneğinde ve töre ülüşte, ganimetin ve gelirin boylar arasında paylaştırılması geleneğidir. Bu pay dağıtımındaki sıra, boyların devlet içindeki yerini de gösterir. (Kaynak: turk-devlet-gelenegi.md)

Getirilen: `turk-kulturunde-at.md#2 0.469 | oguz-boylari-ve-turk-boy-yapisi.md#0 0.462 | turk-devlet-gelenegi.md#5 0.452 | turk-mitolojisi-ve-gok-tanri.md#7 0.433 | ozan-asik-gelenegi.md#3 0.416`

**k-toy** — Toy nedir?
> Toy, devletin önemli kararlarının alındığı meclisdir. Savaş, barış ve hükümdar seçimi gibi konular burada görüşülürdü. Boy beyleri ve hanedan üyeleri katılırken, kararlar tartışılarak alınırdı. Bu yapı, Türk devletlerinde yönetimin tek kişinin keyfine bırakılmadığını gösteren en belirgin unsurdur. (Kaynak: turk-devlet-gelenegi.md)
...
> Örtmece, korkulan ya da saygı duyulan bir varlığın gerçek adını söylemekten kaçınılıp, yerine başka bir sözcük kullanmak şeklinde bir adlandırma yöntemidir. Türkçedeki "kurt" sözcüğünün eski anlamının solucan, kurtçuk, böcek larvası olduğunu gösteren bilgi ve ergenekon destanında kurtun kılavuz rolünü yerine tuttuğu anlatım, ortamda ortmece uygulamasının bir örneğini vermektedir. (Kaynak: turk-kulturunde-kurt.md)

Getirilen: `turk-kulturunde-kurt.md#6 0.424 | bozkir-gocebe-yasami.md#4 0.402 | bozkir-gocebe-yasami.md#0 0.378 | turkcenin-tarihi-ve-alfabeleri.md#0 0.368 | turk-kulturunde-kurt.md#2 0.359`

**k-asena** — Asena nedir?
> Asena, "Aşina"nın modern Türkçe okunuşudur; Göktürklerin türeyiş anlatısında hanedanın adı olarak kullanılır ve soyun bir dişi kurttan geldiği aktarılır. (Kaynak: turk-kulturunde-kurt.md)
...
> Osmanlı başkenti Edirne'ye taşınmasının tam tarihi belirsiz olarak verilmemiştir. Ancak, Bursa'nın 1326 yılında alınması ve Edirne'nin 1362 yılında Osmanlı topraklarına girilmesi arasında bir süre olduğu bilinmektedir. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md)
...
> Dresden ve Vatikan'da bulunan yazmalar esas alınır. (Kaynak: turk-destanlari.md)
...
> İlk görev yeri Şam'da bulunmuştur. (Kaynak: mustafa-kemal-ataturk.md)
...
> Beyliklerin başkenti Bursa'ya taşındıktan sonra Konya'ya taşındı. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md)
...
> Bursa'nın başkenti 1326 yılında Orhan Gazi döneminde yapılmıştır. Selçukluların başkenti daha sonra Konya'ya taşınmıştır. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md, selcuklular-ve-malazgirt.md)
...
> Bağlamda belirtilen bir yapıtta "yıkıldı" ifadesine karşılık gelen tarih bulunmamaktadır. Bu bilgi elimdeki dokümanlarda yok.
...
> Otağ, Türk topluluklarında yurt veya kerege adıyla anılan sökülüp taşınabilen keçe çadırın ismi olan bir yapıdır. Bu yapının tepedeki çemberi hem baca hem pencere görevi görür ve dumanı dışarı verir. Üzeri keçeyle kaplanarak kışın soğuğu geçirmez, sadece sıcağı geçirebilen keçe ile örtülür. (Kaynak: bozkir-gocebe-yasami.md)

Getirilen: `bozkir-gocebe-yasami.md#2 0.461 | turk-destanlari.md#1 0.450 | turk-kulturunde-at.md#0 0.425 | turk-kulturunde-at.md#1 0.409 | ozan-asik-gelenegi.md#1 0.401`
...
> Atlı okçuluk, dörtnala giderken ok atabilme becerisidir. Bu beceri, Türk ordularında atlı savaşın önemli bir özelliği olarak kabul edilir ve ağır piyadeye karşı hareket üstünlüğü sağlamıştır. Bu üstünlük, Turan taktığı adıyla bilinen yöntemde de kullanılmıştır. (Kaynak: turk-kulturunde-at.md)
...
> Yusuf Akçura'nın "Üç Tarz-ı Siyaset" adlı yazısı 1904'te Kahire'de yayımlanmıştır. (Kaynak: turk-milliyetciliginin-dogusu.md)
...
> Tuğrulul Bey, Selçukluların kurucusu olarak anılır. Bağlamda belirtilmemiş ama genel tarihsel bilgi olarak Tuğrul Bey, Selçukluların kurucusu ve tahtaya çıkan ilk sultanıdır. (Kaynak: selcuklular-ve-malazgirt.md)
