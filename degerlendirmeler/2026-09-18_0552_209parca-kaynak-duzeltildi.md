# Değerlendirme: 2026-09-18 05:52 — 209parca-kaynak-duzeltildi
...
| set_parmak_izi | 8efac11e03 |

## Özet

> **Uyarı:** İlk token ortalaması 22.68 sn, 3.0 sn sınırının üstünde. Ekran kartı belleği bozuk düzende olabilir (rag_iyilestirme_plani.md Bölüm 2.5); süre ölçütleri geçersiz sayılmalı. Doğruluk ölçütleri bundan etkilenmez. Sunucuyu yeniden başlatıp (foundry server stop) tekrar ölçün.

Puanlanan soru: 80 (64 cevaplanabilir, 16 cevaplanamaz). Senaryoların hazırlık soruları özete katılmaz.

Karşılaştırılan çalışma: `degerlendirmeler/2026-09-18_0530_209parca-regresyon.json` — **uyarı: soru seti farklı, karşılaştırma kısmen geçerli**

| Ölçüt | Önceki | Şimdi |
|---|---|---|
| Tam başarı (tüm puanlanan sorular) | 82.5% | 87.5% |
| Arama: doğru parça 1. sırada (hit@1) | 76.6% | 82.8% |
| Arama: doğru parça ilk 3'te (hit@3) | 89.1% | 90.6% |
| Arama: MRR (1 = hep 1. sırada) | 0.847 | 0.882 |
| Cevaplanabilir sorularda başarı | 84.4% | 90.6% |
| Yanlış red (cevap belgede varken) | 0.0% | 0.0% |
|   bunun eşikte olanı | 0.0% | 0.0% |
| Anahtar ifadelerin tamamı cevapta | 92.2% | 92.2% |
| Bilinen yanlışı içeren cevap | 1 adet | 1 adet |
| Kaynak satırı var | 100.0% | 100.0% |
| Kaynak doğru belge | 89.1% | 95.3% |
...
| Süre ortalaması | 4.05 sn | 31.97 sn |
| Süre medyanı | 3.4 sn | 32.85 sn |
| En uzun süre | 7.52 sn | 67.22 sn |
| İlk token ortalaması (modele giden sorular) | 2.68 sn | 22.68 sn |
| Arama süresi ortalaması | 0.434 sn | 0.431 sn |

## Kategorilere göre

| Kategori | Soru | Başarılı | hit@1 | hit@3 | Yanlış red |
|---|---|---|---|---|---|
| normal | 46 | 44 | 39 | 43 | 0 |
| ozel_ad | 9 | 8 | 7 | 8 | 0 |
| yakin | 6 | 5 | - | - | - |
| konu_disi | 3 | 3 | - | - | - |
| anlamsiz | 1 | 1 | - | - | - |
...
Cevap metni değişen soru: 7. Sonucu değişen soru: 4.

- **ataturk-5** HATA → OK: Atatürk'ün naaşı Anıtkabir'e ne zaman nakledilmiştir?
- **osmanli-5** HATA → OK: Yıldırım Bayezid Ankara Savaşı'nda kime yenilmiştir?
- **selcuklu-1** HATA → OK: Anadolu Selçuklu Devleti hangi savaşta Moğollara yenilmiştir?
- **alfabe-5** HATA → OK: Kutadgu Bilig hangi yüzyılda yazılmıştır?

## Başarısız sorular

- **selcuklu-4** (normal) Anadolu Selçuklu Devleti'ni kim kurmuştur?
  - Neden: eksik: Süleyman Şah
  - Cevap: Selçuklular ve Anadolu Selçuklu Devleti'ni kurmuş olan kişi doğrudan belirtilmemiş, ancak Selçukluların kuruluşunu 1040 yılındaki Dandanakan Savaşı ile kesinleştiren olay belirtilmiştir. Bu savaşta Tuğrul Bey Gazneli ordusunu yenmiş ve ilk sultan olarak devletin başına geçmiştir. Dolayısıyla, Anadolu Selçuklu Devleti'ni Tuğrul Bey kurmuştur. (Kaynak: selcuklular-ve-malazgirt.md)
- **at-2** (ozel_ad) Kımız nedir?
  - Neden: eksik: kısrak; yanlış kaynak: turk-mitolojisi-ve-gok-tanri.md
  - Cevap: Kımız, kam tarafından elde edilen bir içecektir. Kam, hastaları iyileştirmek, ölünün ruhunu uğurlamak ve gelecekten haber vermek için görevli kişi olduğuna inanılan din adamıdır. Kımız, kamın kamış olarak adlandırduğu kamışın kısaltmasıdır ve kamışın kırsak sütünün mayalanmasıyla elde edildiği bilinmektedir. Bu içecektir hâlâ Kazakistan ve Kırgızistan'da tüketilmektedir. (Kaynak: turk-mitolojisi-ve-gok-tanri.md)
- **kurt-6** (normal) Ergenekon'dan çıkan topluluğa yolu kim göstermiştir?
  - Neden: eksik: Börteçine; doğru parça ilk 3'te değil (sıra 4)
  - Cevap: Ergenekon Destanı'nda, uzun yıllar vadiye sığınan topluluk, demir bir dağı eriterek dışarı çıkmasından sonra kurt kılavuz rolündedir ve topluluğa yolu gösterir. Oğuz Kağan Destanı'nda da ordunun önünde yürüyen kurt anlatılır. (Kaynak: turk-kulturunde-kurt.md)
...
- **degisim-3#2** (konu_degisimi) Kımız nedir?
  ...
  - Neden: eksik: kısrak; doğru parça ilk 3'te değil (sıra 89)
...
|---|---|---|---|---|---|---|---|---|---|
| canakkale-1 | normal | 1 | 0.707 |  |  | tam | doğru | 2.2 | OK |
| canakkale-2 | normal | 1 | 0.561 |  |  | tam | doğru | 2.7 | OK |
| canakkale-3 | normal | 1 | 0.572 |  |  | tam | doğru | 2.5 | OK |
| canakkale-4 | normal | 1 | 0.474 |  |  | tam | doğru | 2.3 | OK |
| canakkale-5 | normal | 2 | 0.492 |  |  | tam | doğru | 2.3 | OK |
| ilkturk-1 | normal | 3 | 0.714 |  |  | tam | doğru | 2.9 | OK |
| ilkturk-2 | normal | 1 | 0.619 |  |  | tam | doğru | 2.7 | OK |
| ilkturk-3 | normal | 1 | 0.758 |  |  | tam | doğru | 2.3 | OK |
| ilkturk-4 | normal | 1 | 0.756 |  |  | tam | doğru | 2.0 | OK |
| ilkturk-5 | normal | 1 | 0.66 |  |  | tam | doğru | 2.0 | OK |
| ataturk-1 | normal | 1 | 0.673 |  |  | tam | doğru | 1.4 | OK |
| ataturk-2 | normal | 1 | 0.693 |  |  | tam | doğru | 1.7 | OK |
| ataturk-3 | normal | 1 | 0.479 |  |  | tam | doğru | 11.6 | OK |
| ataturk-4 | normal | 4 | 0.401 |  |  | tam | doğru | 11.1 | OK |
| ataturk-5 | normal | 1 | 0.745 |  |  | tam | doğru | 2.2 | OK |
| osmanli-1 | normal | 1 | 0.663 |  |  | tam | doğru | 12.4 | OK |
| osmanli-2 | ozel_ad | 1 | 0.566 |  |  | tam | doğru | 2.6 | OK |
| osmanli-3 | ozel_ad | 1 | 0.676 |  |  | tam | doğru | 2.3 | OK |
| osmanli-4 | ozel_ad | 1 | 0.574 |  |  | tam | doğru | 32.3 | OK |
| osmanli-5 | normal | 1 | 0.678 |  |  | tam | doğru | 30.3 | OK |
| osmanli-6 | normal | 1 | 0.705 |  |  | tam | doğru | 30.3 | OK |
| selcuklu-1 | normal | 1 | 0.76 |  |  | tam | doğru | 31.2 | OK |
| selcuklu-2 | normal | 1 | 0.663 |  |  | tam | doğru | 29.6 | OK |
| selcuklu-3 | normal | 1 | 0.756 |  |  | tam | doğru | 30.3 | OK |
| selcuklu-4 | normal | 1 | 0.779 |  |  | eksik | doğru | 29.0 | HATA |
| selcuklu-5 | normal | 1 | 0.484 |  |  | tam | doğru | 29.7 | OK |
| destan-1 | normal | 1 | 0.748 |  |  | tam | doğru | 24.5 | OK |
| destan-2 | normal | 1 | 0.776 |  |  | tam | doğru | 22.3 | OK |
| destan-3 | normal | 1 | 0.838 |  |  | tam | doğru | 35.5 | OK |
| destan-4 | normal | 1 | 0.628 |  |  | tam | doğru | 53.4 | OK |
| destan-5 | normal | 1 | 0.706 |  |  | tam | doğru | 22.0 | OK |
| gelenek-1 | ozel_ad | 4 | 0.559 |  |  | tam | doğru | 64.9 | OK |
| gelenek-2 | ozel_ad | 1 | 0.642 |  |  | tam | doğru | 25.5 | OK |
| gelenek-3 | normal | 1 | 0.663 |  |  | tam | doğru | 21.6 | OK |
| gelenek-4 | normal | 1 | 0.455 |  |  | tam | doğru | 28.3 | OK |
| gelenek-5 | ozel_ad | 1 | 0.552 |  |  | tam | doğru | 32.8 | OK |
| at-1 | normal | 1 | 0.656 |  |  | tam | doğru | 57.7 | OK |
| at-2 | ozel_ad | 2 | 0.351 |  |  | eksik | yanlış | 32.5 | HATA |
| at-3 | normal | 1 | 0.74 |  |  | tam | doğru | 52.2 | OK |
| at-4 | normal | 1 | 0.582 |  |  | tam | doğru | 29.5 | OK |
| kurt-1 | normal | 1 | 0.725 |  |  | tam | doğru | 28.9 | OK |
| kurt-2 | ozel_ad | 1 | 0.563 |  |  | tam | doğru | 65.8 | OK |
| kurt-3 | ozel_ad | 1 | 0.52 |  |  | tam | doğru | 39.9 | OK |
| kurt-4 | normal | 1 | 0.83 |  |  | tam | doğru | 25.2 | OK |
| kurt-5 | normal | 2 | 0.71 |  |  | tam | doğru | 31.4 | OK |
| kurt-6 | normal | 4 | 0.684 |  |  | eksik | doğru | 53.7 | HATA |
| dogus-1 | normal | 1 | 0.687 |  |  | tam | doğru | 35.2 | OK |
| dogus-2 | normal | 7 | 0.649 |  |  | tam | doğru | 37.1 | OK |
| dogus-3 | normal | 1 | 0.773 |  |  | tam | doğru | 33.4 | OK |
| dogus-4 | normal | 1 | 0.75 |  |  | tam | doğru | 38.0 | OK |
| alfabe-1 | normal | 1 | 0.719 |  |  | tam | doğru | 37.8 | OK |
| alfabe-2 | normal | 1 | 0.712 |  |  | tam | doğru | 39.6 | OK |
| alfabe-3 | normal | 2 | 0.76 |  |  | tam | doğru | 47.2 | OK |
| alfabe-4 | normal | 1 | 0.816 |  |  | tam | doğru | 30.2 | OK |
| alfabe-5 | normal | 1 | 0.788 |  |  | tam | doğru | 42.9 | OK |
| cevapsiz-1 | yakin |  | 0.652 |  | evet |  |  | 34.5 | OK |
| cevapsiz-2 | yakin |  | 0.691 |  | evet |  |  | 34.9 | OK |
| cevapsiz-3 | yakin |  | 0.575 |  | evet |  |  | 42.7 | OK |
| cevapsiz-4 | yakin |  | 0.533 |  |  |  | var | 40.7 | HATA |
| cevapsiz-5 | yakin |  | 0.659 |  | evet |  |  | 28.4 | OK |
| cevapsiz-6 | yakin |  | 0.516 |  | evet |  |  | 33.4 | OK |
| cevapsiz-7 | konu_disi |  | 0.381 |  | evet |  |  | 33.2 | OK |
| cevapsiz-8 | konu_disi |  | 0.367 |  | evet |  |  | 37.9 | OK |
| cevapsiz-9 | konu_disi |  | 0.368 |  | evet |  |  | 32.9 | OK |
| cevapsiz-10 | anlamsiz |  | 0.372 |  | evet |  |  | 33.1 | OK |
| takip-1#1 | hazirlik |  | 0.663 |  |  |  | var | 31.4 | - |
| takip-1#2 | takip | 1 | 0.681 |  |  | tam | yanlış | 42.0 | HATA |
| takip-2#1 | hazirlik |  | 0.742 |  |  |  | var | 47.2 | - |
| takip-2#2 | takip | 5 | 0.734 |  |  | eksik | yanlış | 44.1 | HATA |
| takip-3#1 | hazirlik |  | 0.748 |  |  |  | var | 27.5 | - |
| takip-3#2 | takip | 1 | 0.79 |  |  | tam | doğru | 36.5 | OK |
| takip-4#1 | hazirlik |  | 0.705 |  |  |  | var | 42.7 | - |
| takip-4#2 | takip | 1 | 0.699 |  |  | tam | doğru | 39.3 | OK |
| takip-5#1 | hazirlik |  | 0.753 |  |  |  | var | 34.6 | - |
| takip-5#2 | takip | 1 | 0.726 |  |  | tam | doğru | 30.2 | OK |
| takip-cevapsiz-1#1 | hazirlik |  | 0.572 |  |  |  | var | 44.2 | - |
| takip-cevapsiz-1#2 | takip_cevapsiz |  | 0.579 |  |  |  | var | 61.8 | HATA |
| takip-cevapsiz-2#1 | hazirlik |  | 0.75 |  |  |  | var | 31.6 | - |
| takip-cevapsiz-2#2 | takip_cevapsiz |  | 0.511 |  |  |  | var | 37.3 | HATA |
| degisim-1#1 | hazirlik |  | 0.563 |  |  |  | var | 56.8 | - |
| degisim-1#2 | konu_degisimi | 1 | 0.566 |  |  | tam | doğru | 48.3 | OK |
| degisim-2#1 | hazirlik |  | 0.574 |  |  |  | var | 55.6 | - |
| degisim-2#2 | konu_degisimi | 1 | 0.563 |  |  | tam | doğru | 67.2 | OK |
| degisim-3#1 | hazirlik |  | 0.656 |  |  |  | var | 58.3 | - |
| degisim-3#2 | konu_degisimi | 89 | 0.657 |  |  | eksik | doğru | 57.1 | HATA |
| degisim-4#1 | hazirlik |  | 0.712 |  |  |  | var | 40.3 | - |
| degisim-4#2 | konu_degisimi | 1 | 0.552 |  |  | tam | doğru | 46.4 | OK |
| disi-1#1 | hazirlik |  | 0.676 |  |  |  | var | 41.0 | - |
| disi-1#2 | konu_disi_sonra |  | 0.381 |  | evet |  |  | 33.8 | OK |
| disi-2#1 | hazirlik |  | 0.725 |  |  |  | var | 30.5 | - |
| disi-2#2 | konu_disi_sonra |  | 0.719 |  | evet |  |  | 29.5 | OK |
| disi-3#1 | hazirlik |  | 0.676 |  |  |  | var | 41.6 | - |
| disi-3#2 | konu_disi_sonra |  | 0.599 |  |  |  | var | 61.6 | HATA |
| disi-4#1 | hazirlik |  | 0.663 |  |  |  | var | 32.0 | - |
| disi-4#2 | konu_disi_sonra |  | 0.368 |  | evet |  |  | 34.1 | OK |
...
> Osman Gazi, Osmanlı Devleti'nin kurucusudur. Devletin kuruluşu geleneksel olarak 1299 yılında t tarihlenmektedir. (Kaynak: osmanli-padisahlari.md)
...
> Anadolu Selçuklu Devleti 1243'teki Kösedağ Savaşı'nda Moğollara yenilmiştir. (Kaynak: anadolu-beylikleri-ve-osmanlinin-kurulusu.md)

Getirilen: `anadolu-beylikleri-ve-osmanlinin-kurulusu.md#0 0.760 | selcuklular-ve-malazgirt.md#4 0.748 | selcuklular-ve-malazgirt.md#3 0.675 | anadolu-beylikleri-ve-osmanlinin-kurulusu.md#1 0.597 | turklerin-islamiyeti-kabulu.md#6 0.587`
...
Getirilen: `selcuklular-ve-malazgirt.md#0 0.756 | selcuklular-ve-malazgirt.md#3 0.647 | turklerin-islamiyeti-kabulu.md#6 0.631 | anadolu-beylikleri-ve-osmanlinin-kurulusu.md#8 0.591 | anadolu-beylikleri-ve-osmanlinin-kurulusu.md#0 0.590`

**selcuklu-4** — Anadolu Selçuklu Devleti'ni kim kurmuştur?
> Selçuklular ve Anadolu Selçuklu Devleti'ni kurmuş olan kişi doğrudan belirtilmemiş, ancak Selçukluların kuruluşunu 1040 yılındaki Dandanakan Savaşı ile kesinleştiren olay belirtilmiştir. Bu savaşta Tuğrul Bey Gazneli ordusunu yenmiş ve ilk sultan olarak devletin başına geçmiştir. Dolayısıyla, Anadolu Selçuklu Devleti'ni Tuğrul Bey kurmuştur. (Kaynak: selcuklular-ve-malazgirt.md)

Getirilen: `selcuklular-ve-malazgirt.md#3 0.779 | anadolu-beylikleri-ve-osmanlinin-kurulusu.md#0 0.756 | anadolu-beylikleri-ve-osmanlinin-kurulusu.md#1 0.725 | selcuklular-ve-malazgirt.md#0 0.691`
...
> Ergenekon'dan çıkış günü, bazı Türk topluluklarında bahar bayramı olarak kutlanmıştır. Anlatıya göre, düşman saldırılarından kurtulan küçük bir topluluk dağlarla çevrili bir vadiye sığınır ve uzun yıllar çoğalır. Sonunda demir bir dağı eriterek dışarı çıkar ve bu çıkış günü yeni bir başlangıç olarak kutlanır. Bu bağlama göre bayram bazı topluluklarda Ergenekon Bayramı ya da Bozkurt Bayramı adıyla da anılır. (Kaynak: turk-destanlari.md)

Getirilen: `turk-destanlari.md#2 0.628 | nevruz-ve-turk-bayramlari.md#1 0.502 | turk-kulturunde-kurt.md#2 0.446`
...
**at-2** — Kımız nedir?
> Kımız, kam tarafından elde edilen bir içecektir. Kam, hastaları iyileştirmek, ölünün ruhunu uğurlamak ve gelecekten haber vermek için görevli kişi olduğuna inanılan din adamıdır. Kımız, kamın kamış olarak adlandırduğu kamışın kısaltmasıdır ve kamışın kırsak sütünün mayalanmasıyla elde edildiği bilinmektedir. Bu içecektir hâlâ Kazakistan ve Kırgızistan'da tüketilmektedir. (Kaynak: turk-mitolojisi-ve-gok-tanri.md)

Getirilen: `turk-mitolojisi-ve-gok-tanri.md#5 0.351 | turk-kulturunde-at.md#3 0.346 | turk-kulturunde-kurt.md#6 0.330 | bozkir-gocebe-yasami.md#4 0.314 | bozkir-gocebe-yasami.md#2 0.305`
...
> Ergenekon Destanı'nda, uzun yıllar vadiye sığınan topluluk, demir bir dağı eriterek dışarı çıkmasından sonra kurt kılavuz rolündedir ve topluluğa yolu gösterir. Oğuz Kağan Destanı'nda da ordunun önünde yürüyen kurt anlatılır. (Kaynak: turk-kulturunde-kurt.md)

Getirilen: `turk-destanlari.md#2 0.684 | bozkir-gocebe-yasami.md#7 0.544 | nevruz-ve-turk-bayramlari.md#1 0.543 | turk-kulturunde-kurt.md#2 0.527 | bozkir-gocebe-yasami.md#6 0.496`
