# Değerlendirme: 2026-09-14 20:06 — faz56b-dar-dogrulama
...
| Cevaplanabilir sorularda başarı | 88.9% | 77.8% |
| Yanlış red (cevap belgede varken) | 7.4% | 22.2% |
...
| Doğrulamada reddedilen cevaplanabilir | - | 4 adet |
| Doğrulamada reddedilen cevaplanamaz | - | 2 adet |
| Türkçe olmayan yazı kalan cevap | - | 0 adet |
| Türkçe olmayan yazı kesilen cevap | - | 1 adet |
| Süre ortalaması | 2.11 sn | 2.69 sn |
| Süre medyanı | 2.05 sn | 2.71 sn |
| En uzun süre | 3.09 sn | 3.99 sn |
| İlk token ortalaması (modele giden sorular) | 0.81 sn | 0.81 sn |
| Arama süresi ortalaması | 0.49 sn | 0.524 sn |

## Kategorilere göre

| Kategori | Soru | Başarılı | hit@1 | hit@3 | Yanlış red |
|---|---|---|---|---|---|
| normal | 15 | 13 | 14 | 15 | 2 |
| ozel_ad | 5 | 3 | 4 | 4 | 2 |
| yakin | 8 | 8 | - | - | - |
| takip | 4 | 4 | 4 | 4 | 0 |
| takip_cevapsiz | 6 | 6 | - | - | - |
...
Cevap metni değişen soru: 8. Sonucu değişen soru: 5.

- **k-kurt-neden** OK → HATA: Türk kültüründe sembol olarak neden kurt seçilmiştir? (yanlış red (doğrulama))
- **k-asena** OK → HATA: Asena nedir? (yanlış red (doğrulama))
...
| k-mete | normal | 1 | 0.578 |  |  | tam | doğru | 2.5 | OK |
| k-kutluk | normal | 1 | 0.677 |  |  | tam | doğru | 2.7 | OK |
| k-baba | normal | 1 | 0.747 |  |  | tam | doğru | 2.8 | OK |
...
| k-harf-sayisi | normal | 1 | 0.793 |  | evet |  |  | 3.4 | HATA |
| k-millet-mektep | normal | 1 | 0.608 |  |  | tam | doğru | 2.8 | OK |
| k-bildiri | normal | 2 | 0.814 |  |  | tam | doğru | 3.5 | OK |
| k-veteriner | normal | 1 | 0.81 |  |  | tam | doğru | 3.0 | OK |
| k-kurt-neden | normal | 1 | 0.836 |  | evet |  |  | 3.7 | HATA |
| k-ad-koyma | normal | 1 | 0.773 |  |  | tam | doğru | 3.5 | OK |
| k-ulus | ozel_ad | 4 | 0.469 |  | evet |  |  | 1.3 | HATA |
| k-toy | ozel_ad | 1 | 0.406 |  |  | tam | doğru | 3.2 | OK |
| k-manasci | ozel_ad | 1 | 0.534 |  |  | tam | doğru | 2.5 | OK |
| k-ortmece | ozel_ad | 1 | 0.424 |  |  | tam | doğru | 3.3 | OK |
| k-asena | ozel_ad | 1 | 0.433 |  | evet |  |  | 3.0 | HATA |
...
| k-dogu-cephesi | yakin |  | 0.662 |  | evet |  |  | 2.9 | OK |
| k-takip-gokalp#1 | hazirlik |  | 0.77 |  |  |  | var | 2.6 | - |
| k-takip-gokalp#2 | takip | 1 | 0.809 |  |  | tam | doğru | 3.5 | OK |
| k-takip-korkut#1 | hazirlik |  | 0.776 |  |  |  | var | 2.5 | - |
| k-takip-korkut#2 | takip | 1 | 0.79 |  |  | tam | doğru | 3.1 | OK |
| k-takip-sam#1 | hazirlik |  | 0.706 |  |  |  | var | 2.7 | - |
| k-takip-sam#2 | takip | 1 | 0.76 |  |  | tam | doğru | 3.1 | OK |
| k-takip-konya#1 | hazirlik |  | 0.721 |  |  |  | var | 2.7 | - |
| k-takip-konya#2 | takip | 1 | 0.74 |  |  | tam | doğru | 3.4 | OK |
| k-cevapsiz-malazgirt#1 | hazirlik |  | 0.663 |  |  |  | var | 2.7 | - |
| k-cevapsiz-malazgirt#2 | takip_cevapsiz |  | 0.419 |  | evet |  |  | 2.4 | OK |
| k-cevapsiz-nutuk#1 | hazirlik |  | 0.503 |  |  |  | var | 3.0 | - |
| k-cevapsiz-nutuk#2 | takip_cevapsiz |  | 0.346 |  | evet |  |  | 1.9 | OK |
| k-cevapsiz-tdk#1 | hazirlik |  | 0.76 |  |  |  | var | 3.0 | - |
...
| k-cevapsiz-baskent#1 | hazirlik |  | 0.766 |  |  |  | var | 2.5 | - |
| k-cevapsiz-baskent#2 | takip_cevapsiz |  | 0.722 |  | evet |  |  | 2.2 | OK |
| k-cevapsiz-uygur#1 | hazirlik |  | 0.66 |  |  |  | var | 2.6 | - |
| k-cevapsiz-uygur#2 | takip_cevapsiz |  | 0.435 |  | evet |  |  | 3.4 | OK |
| k-degisim-otag#1 | hazirlik |  | 0.485 |  |  |  | var | 2.7 | - |
...
| k-degisim-tugrul#1 | hazirlik |  | 0.69 |  |  |  | var | 3.0 | - |
| k-degisim-tugrul#2 | konu_degisimi | 5 | 0.496 |  |  | tam | doğru | 3.8 | OK |
| k-disi-telefon#1 | hazirlik |  | 0.631 |  |  |  | var | 2.9 | - |
| k-disi-telefon#2 | konu_disi_sonra |  | 0.572 |  | evet |  |  | 2.1 | OK |
| k-disi-yagmur#1 | hazirlik |  | 0.75 |  |  |  | var | 2.5 | - |
