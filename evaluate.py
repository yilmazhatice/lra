...
CASES = [
    ("RAG'in üç adımı nedir?", "01.md"),
    ("RAG hangi iki pratik sorunu çözer?", "01.md"),
    ("Kosinüs benzerliği hangi aralıkta değer alır?", "02.md"),
    ("Anlamsal arama anahtar kelime aramasından neden üstündür?", "02.md"),
    ("Vektörler neden JSON yerine BLOB olarak saklanır?", "03.md"),
    ("SQLite neden ayrı bir sunucu gerektirmez?", "03.md"),
    ("Foundry Local hangi API biçimini konuşur?", "04.md"),
    ("Sistem mesajı ile kullanıcı mesajı arasındaki fark nedir?", "05.md"),
    ("Türkiye'nin başkenti neresi?", None),
    ("Bugün hava nasıl olacak?", None),
    ("Python'da bir listeyi nasıl ters çeviririm?", None),
